...
import SkelUser from "../skeleton/SkelUser"
...
function Profile(props) {
  ...
  const {
    classes,
    user: {
      credentials: { handle, createdAt, imageUrl, bio, website, location, navColor },
      loading,
      authenticated,
    },
  } = props
      ...
      <Paper className={classes.paper}>
        <div className={classes.profile}>
          <div className="image-wrapper">
            ...
            <MyButton tip="Edit Profile Photo" onClick={handleEditPhoto} btnClassName="button">
      ...
      <Paper className={classes.paper}>
        <Typography variant="body2" align="center">
          ...
          <div className={classes.buttons}>
            <Button variant="contained" style={{ color: navColor }} component={Link} to="/login">
              Login
            </Button>
            <Button
              variant="contained"
