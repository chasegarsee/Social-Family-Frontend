...
function PostDialogWithChat(props) {
  ...
  return (
    <Fragment>
      <ChatIcon onClick={handleOpen} color="secondary" />
...
export default connect(mapStateToProps, mapActionsToProps)(withStyles(styles)(PostDialogWithChat))
